...
#' these points.
#' @param crs_default A proj4string or EPSG Code to specify the default 
...
#' @param break_closed_loops - (default: FALSE)
#' @param delete_disconnected - (default: FALSE)
...
#' @param landuse_classes A data.frame including percentages of imperviousness 
#' of the different landuse classes. See vignette.
#' @param path_timeseries Path to a raindata file in dat format including rain 
#' data to size the pipe diameter.
#' @param path_options Path to an option file specifying swmm options. See 
#' \link[swmmr]{shp_to_inp}
#' @param infiltration A data.frame specifying infiltration information for soil 
...
create_swmm_model <- function(streets, 
  ...
  network_list <- create_drainage_network(streets, 
                                          dtm, 
                                          outfalls, 
                                          crs_default, 
                                          buffer, 
