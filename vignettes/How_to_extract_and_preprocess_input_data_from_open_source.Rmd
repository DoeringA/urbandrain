...
Additionally the following input data is needed. These input data require some basic knowledge of the model site:
...
- A range within the junctions depths are allowed to vary (**min_junc_depth**, **mean_junc_depth**, **max_junc_depth**).
...
landuse_classes <- data.frame(class = unique(landuse_complete$landuse), imperviousness = c(0.5,0,0,1,1))
landuse_classes
